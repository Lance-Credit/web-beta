            ...
            <div class="mb-6 flex gap-6">
                ...
                <div class="basis-[421px] py-8 px-6 rounded-xl bg-white border border-solid border-lance-green-10 grow">
                    ...
                    <div class="w-[236px] mx-auto relative text-center pt-[63.8px]">
                        <svg v-if="!activeLoan" width="237" height="238" viewBox="0 0 237 238" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute top-0">
                            ...
                            <path d="M143.202 11.3818C143.737 8.86301 146.216 7.24581 148.711 7.8815C159.438 10.6142 169.722 14.8611 179.251 20.4941C181.468 21.8044 182.083 24.6995 180.685 26.862C179.287 29.0246 176.406 29.635 174.185 28.3324C165.615 23.3069 156.389 19.4966 146.771 17.0107C144.277 16.3663 142.666 13.9006 143.202 11.3818Z" fill="#FF614F"/>
                            <path d="M184.596 27.2601C186.141 25.2005 189.07 24.7765 191.067 26.4032C199.382 33.1792 206.722 41.0707 212.879 49.8539C214.357 51.9625 213.722 54.8533 211.556 56.2459C209.39 57.6385 206.514 57.005 205.028 54.9016C199.48 47.0449 192.899 39.9701 185.464 33.8681C183.474 32.2345 183.05 29.3197 184.596 27.2601Z" fill="#ECF100" fill-opacity="0.9"/>
                            <path d="M213.36 59.2431C215.51 57.8257 218.41 58.4149 219.741 60.6198C229.886 77.435 235.62 96.5437 236.406 116.167C236.51 118.74 234.413 120.829 231.837 120.829C229.262 120.829 227.185 118.74 227.073 116.168C226.298 98.3695 221.099 81.0426 211.948 65.757C210.626 63.5476 211.21 60.6605 213.36 59.2431Z" fill="#5CB77B"/>
                        ...
                        <li v-for="(repayment, key) in activeLoan.repayments" :key="key" class="py-4 border-b border-solid border-lance-green-10 flex items-center justify-between">
                            <div>
                                ...
                                <p class="flex gap-2 items-center">
                                    ...
                                    <span class="text-lance-black-50 text-sm leading-5">Due: {{ repayment.date }}</span>
                                </p>
                            </div>
