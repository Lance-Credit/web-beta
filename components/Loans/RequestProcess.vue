<template>
    <div>
        ...
        <div class="sm:rounded-xl sm:bg-white sm:border border-solid border-lance-black-10 sm:p-20">
            <svg @click="emit('@close-loan-application-modal')" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="sm:hidden mb-[34px]">
            ...
            <div v-show="activeTab == 'request'" class="flex flex-col gap-6 w-full sm:w-[376px] mx-auto">
                <div>
                    <p class="mb-0.5 text-[#1E1721] font-aventa text-xl sm:text-2xl leading-8 tracking-[-0.2px] sm:tracking-[-0.24px]">
                        Apply for a Loan
                    </p>
            ...
            <div v-show="activeTab == 'summary'" class="flex flex-col gap-6 w-full sm:w-[386px] mx-auto">
                <div>
                    <p class="mb-0.5 text-[#1E1721] font-aventa text-xl sm:text-2xl leading-8 tracking-[-0.2px] sm:tracking-[-0.24px]">
                        Loan Summary
                    </p>
                ...
                <div>
                    <ul class="p-6 rounded-lg border border-solid border-lance-black bg-[rgba(236,255,77,0.05)]">
                        <li class="flex items-center justify-between pb-4 border-b border-solid border-b-lance-green-5">
                            <p class="text-lance-black-70 text-xs sm:text-sm leading-[18px] sm:leading-[21px] flex items-center gap-2">
                            ...
                            <p class="text-lance-black text-sm sm:text-base leading-6">
                                N {{ Number(loanRequestFormValues.loanAmount)?.toLocaleString() }}
                            </p>
                        </li>
                        <li class="flex items-center justify-between py-4 border-b border-solid border-b-lance-green-5">
                            ...
                            <p class="text-lance-black text-sm sm:text-base leading-6">
                                N {{ ((loanSummary?.totalRepaymentAmount || 0) - loanRequestFormValues.loanAmount).toLocaleString() }}
                            </p>
                        </li>
                        <li class="flex items-center justify-between py-4 border-b border-solid border-b-lance-green-5">
                            <p class="text-lance-black-70 text-xs sm:text-sm leading-[18px] sm:leading-[21px] flex items-center gap-2">
                            ...
                            <p class="text-lance-black text-sm sm:text-base leading-6">
                                N {{ loanSummary?.processingFee.toLocaleString() }}
                            </p>
                        </li>
                        <li class="flex items-center justify-between py-4 border-b border-solid border-b-lance-green-5">
                            <p class="text-lance-black-70 text-xs sm:text-sm leading-[18px] sm:leading-[21px] flex items-center gap-2">
                        ...
                        <li class="flex items-center justify-between pt-4">
                            ...
                            <p class="text-lance-black text-sm sm:text-base leading-6">
                                N {{ (loanSummary?.monthlyRepaymentAmount)?.toLocaleString() }} monthly
                            </p>
                        </li>
                    </ul>
