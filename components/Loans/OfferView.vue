<template>
    <div @click.self="emit('@close-loan-details-modal')" class="fixed z-20 top-0 left-0 w-screen h-screen bg-lance-black-10 backdrop-blur-[2px] flex items-center justify-center">
