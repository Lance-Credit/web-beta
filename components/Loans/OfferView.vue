        ...
        <div class="flex flex-col gap-6 w-[456px] mx-auto bg-white p-10 rounded-3xl">
            ...
            <div class="rounded-lg border border-solid border-lance-black bg-[rgba(236,255,77,0.05)]">
                <div class="p-6 bg-lance-green-5 text-center">
                    ...
                    <p class="text-lance-green text-xl font-semibold leading-[30px]">N{{ (loan?.totalRepaymentAmount)?.toLocaleString() }}</p>
                </div>
                <ul class="pt-8 pb-6 px-4">
                    ...
                    <li class="flex items-center justify-between py-4 border-b border-solid border-b-lance-green-5">
                        ...
                        <p class="text-lance-black text-xs">{{ loan?.reference }}</p>
                    </li>
                    <li class="flex items-center justify-between py-4 border-b border-solid border-b-lance-green-5">
                        <p class="text-lance-black-70 text-sm leading-[21px] flex items-center gap-2">
                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="text-lance-black">N{{ loan?.totalInterestAmount ? (loan?.totalInterestAmount/100).toLocaleString() : '0.00' }}</p>
                    </li>
                    <li class="flex items-center justify-between py-4 border-b border-solid border-b-lance-green-5">
                        <p class="text-lance-black-70 text-sm leading-[21px] flex items-center gap-2">
                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span>Processing Fee ({{ loan?.feeCharged ? loan?.feeCharged * 100 : '0.00' }}%)</span>
                        </p>
                        <p class="text-lance-black">N{{ loan?.feeAmount ?  (loan?.feeAmount / 100).toLocaleString() : '0.00' }}</p>
                    </li>
                    <li class="flex items-center justify-between py-4 border-b border-solid border-b-lance-green-5">
                        <p class="text-lance-black-70 text-sm leading-[21px] flex items-center gap-2">
                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
