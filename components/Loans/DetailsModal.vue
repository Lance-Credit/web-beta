<template>
    <div class="fixed z-20 top-0 left-0 w-screen h-screen bg-lance-black-70 backdrop-blur-[2px] flex items-center justify-center">
        <div class="bg-white w-[466px] rounded-3xl p-10 flex flex-col gap-6">
            ...
            <div v-show="!loan?.active" class="flex items-center justify-between">
                <div>
            ...
            <div>
                <ul class="p-6 rounded-lg border border-solid border-lance-black bg-[rgba(236,255,77,0.05)]">
                    ...
                    <li class="flex items-center justify-between py-4 border-b border-solid border-b-lance-green-5">
                        ...
                        <p class="text-lance-black">{{ loan?.duration }} months</p>
                    </li>
                    <li class="flex items-center justify-between py-4 border-b border-solid border-b-lance-green-5">
                        <p class="text-lance-black-70 text-sm leading-[21px]">Monthly Repayment</p>
                        <p class="text-lance-black">N{{ (loan?.repayments[0].amount)?.toLocaleString() }} every month</p>
                    </li>
                ...
                <div v-show="loan?.active" class="mt-4 p-6 rounded-lg border border-solid border-lance-black bg-[rgba(236,255,77,0.05)]">
